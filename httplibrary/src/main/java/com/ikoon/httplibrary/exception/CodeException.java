...
public class CodeException
{
    ...
    @IntDef({UNKNOWN_ERROR, NETWORK_ERROR, TIMEOUT_ERROR, SSL_ERROR, UNKNOWN_HOST_ERROR, ILLEGAL_STATE_ERROR, RUNTIME_ERROR, NULL_POINTER_ERROR, CAST_ERROR, JSON_PARSE_ERROR})
